...
new_mileages = np.array([[15000], [30000], [70000]])  # Пробеги для предсказания
...
plt.scatter(new_mileages, predicted_prices, color='orange', label='Predicted Prices for New Mileages', s=100, edgecolor='k')
